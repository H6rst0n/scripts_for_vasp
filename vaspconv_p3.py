...
try:
    with open("CONTCAR","r") as CONTCAR:         # get CONTCAR infomation
        contcar = [x.split() for x in CONTCAR]
        if contcar[7][0][0] == "s" or contcar[7][0][0] == "S":
                motherfuker = 1
                del contcar[0:9]
        else:
                motherfuker = 0
        ...
        sys.stderr.write("There was a problem opening the POSCAR/CONTCAR file. Does it exist at all?")
...
if outcar != None:
        ...
        for f in range(0,natoms):
                if motherfuker == 1 :
                        if contcar[f][3] == "T" or contcar[f][4] == "T" or contcar[f][5] == "T":
                                nfreeAtom += 1
                else:
                        nfreeAtom = natoms
        ...
        for line in outcarlines:
                ...
                if re_force.search(line):
                        ...
                        average = sum(magnitudes)/nfreeAtom
